...
def _build_summary(results: list[BatchResultItem]) -> EconomicSummary:
    ...
    daily_10k = avg * REVIEWS_PER_DAY_BENCHMARK
    monthly_10k = daily_10k * 30
    savings = round((monthly_10k / 1_000_000) * COST_PER_MILLION, 2)
    return EconomicSummary(
        total_reviews=total,
        total_tokens_processed=total_tokens,
        projected_daily_tokens_10k=daily_10k,
        projected_monthly_tokens_10k=monthly_10k,
